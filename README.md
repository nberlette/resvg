...
TypeScript + WebAssembly bindings for [`resvg`].</b></big>
...
| `fontFamily`     | `string`             | The default font family to use.                              | <pre><code>sans-serif</code></pre> |
...
[Nicholas Berlette]: https://github.com/nberlette "Follow Nicholas Berlette on GitHub for more projects!"
